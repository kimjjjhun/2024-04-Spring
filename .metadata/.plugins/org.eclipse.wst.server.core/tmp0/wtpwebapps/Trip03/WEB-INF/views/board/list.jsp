        ...
        <div class="container">
            <table class="board-table">
                ...
                <tr>
                    ...
                    <th scope="col" class="th-date">프로필</th>
                    <th scope="col" class="th-date">작성자</th>
                    <th scope="col" class="th-date">작성일</th>
                    <th scope="col" class="th-date">수정일</th>
                    <th scope="col" class="th-date"><img alt="" src="/resources/image/like.png" style="margin-left: 60px;"></th>
                </tr>
                </thead>
                <tbody>
					<tr>
				...
				<c:forEach var="board" items="${list}">
						...
						<td><c:forEach var="member" items="${member}">
						<img src="/resources/profileimage/${member.image}" alt="" width="60" height="60" style="margin-left: 50px; border: 2px solid #000;">
					</c:forEach></td>
