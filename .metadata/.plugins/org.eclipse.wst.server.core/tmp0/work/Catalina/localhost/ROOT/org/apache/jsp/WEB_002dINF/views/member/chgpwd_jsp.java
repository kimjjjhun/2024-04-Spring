 ...
 * Generated at: 2024-05-24 03:01:39 UTC
...
public final class chgpwd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		<form action=\"/member/chgpwd\" method=\"post\" id=\"pwdForm\">\n");
      ...
      out.write("		</div>\n");
      out.write("		<div>\n");
      out.write("			<h1 style=\"margin-bottom:25px; font-size:25px; font-weight:bold;\">비밀번호 재설정</h1>\n");
      ...
      out.write("				<input type=\"password\" name=\"pwd-repeat\" placeholder=\"비밀번호를 재입력해주세요\" />\n");
      out.write("			\n");
      out.write("				<button type=\"submit\" id=\"submitBtn\" style=\"border-radius:5px; margin-top:15px;\" >비밀번호 변경</button>\n");
      ...
      out.write("			var pwdForm = $(\"#pwdForm\");\n");
      out.write("			if(pwdForm.find(\"input[name='pwd']\").val()===\"\"){\n");
      out.write("				alert(\"변경할 비밀번호를 입력해주세요\")\n");
      out.write("				return false;\n");
      out.write("			}\n");
      out.write("			if(pwdForm.find(\"input[name='pwd-repeat']\").val()===\"\"){\n");
      out.write("				alert(\"비밀번호를 재입력해주세요\")\n");
      out.write("				return false\n");
      out.write("			}\n");
      out.write("			if(pwdForm.find(\"input[name='pwd']\").val().length<8){\n");
      out.write("				alert(\"비밀번호는 8자리 이상이어야 합니다.\")\n");
      out.write("				return false;\n");
      out.write("			}\n");
      out.write("			if(pwdForm.find(\"input[name='pwd']\").val()!=pwdForm.find(\"input[name='pwd-repeat']\").val()){\n");
