...
<h2 style="font-weight:bold; margin-top: 10px;">${areaname }</h2>
<h5 id="dateRange" style="font-weight:bold;"></h5>

<div class="timeSetter">
<h6 style="font-family: fantasy; font-size: 25px; margin-bottom: 50px; margin-top: 30px;">여행시간 상세설정</h6>
<label class="selectDayBtn" for="modal-toggle"><input type="text" class="totalTime" value="총시간" readonly="readonly" style="border: none; width:300px; color: blue;">
<br>
<div style="margin-top: 50px;">입력하신 여행 기간이 시차를 고려한 <b>현지 여행 기간(여행지 도착 날짜, 여행지 출발 날짜)</b>이 맞는지 확인해 주시고 각 날짜의 일정 <b>시작시간</b>과 <b>종료시간</b>을 현지 시간 기준으로 설정해 주세요. 기본 설정 시간은 <b>오전 10시~오후 10시 총 12시간</b>입니다.
</div><br><p style="font-family: fantasy; font-size: 25px;">일정 수정하기<img alt="" src="../resources/image/left.png"> </p></label><br>
...
<td class="p-1.5"><ins class="date2"></ins></td>
...
<button class="flex items-center justify-center w-full p-2 mt-4 text-sm text-white bg-black rounded-md md:mt-0 font-Montserrat" style="margin-left: 150px; border-radius:20px;">시간 설정 완료</button>
</div>
</div>
