...
<body>
  <div class="page-title">
        <div class="container">
            <h3 style="margin-top: 30px; font-family:serif;">M y P a g e</h3>
        </div>
        
         <div class="page-title"  style="margin-top: 150px">
        <div class="container">
        <c:forEach var="member" items="${member}">
            <h3 style="margin-top: 30px; font-family:serif;">M y P a g e<img src="/resources/profileimage/${member.image}" alt="" width="60" height="60" style="margin-left: 620px; margin-top:30px; border: 2px solid #000;"></h3>
        </c:forEach>
            <h5><a class="nav-link" href="/member/membermodify" style="text-align: center; margin-top: 30px"><strong>프로필 수정하러 가기</strong></a></h5>
        </div>
    </div>
        
         <div class="container">
            <h3 style="margin-top: 100px; float: left; font-size: 30px">나의일정</h3>
             <button id="addplanBtn" class="btn btn-dark" style="float: right; margin-top: 20px">여행계획하기</button>
        </div>
    </div>
  <!-- board list area -->
    <div id="board-list" style="margin-bottom: 200px;">
        <div class="container">
            <table class="board-table">
                <thead>
                <tr style="font-family:fantasy; font-size: 20px">
