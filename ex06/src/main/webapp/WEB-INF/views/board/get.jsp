						...
						<div>
							<div class="header">
								<strong class="primary-font">user00</strong> <small
									class="pull-right text-muted">2024-04-22 14:12:00</small>
							</div>
						</div>
						<p>Good Job!</p>
					</li>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<label>member_email</label> <input class="form-control" name="member_email"
						value="New member_email......." readonly="readonly">
				</div>
...
$(document).ready(function(){
	...
	<sec:authorize access="isAuthenticated()">
	member_email = '<sec:authentication property="principal.username" />'
	</sec:authorize>
	...
	modalRegisterBtn.on("click", function(e){
		...
		var reply = {
			...
			member_email: modalInputmember_email.val(),
			bno : bnoValue
		}
	...
	modalModBtn.on("click", function(e){
		...
		var originalmember_email = modalInputmember_email.val();
	...
	modalRemoveBtn.on("click", function(e){
		...
		replyService.remove(rno,originalmember_email, function(result){
			alert(result);
			modal.modal("hide")
			showList(pageNum)
		})
